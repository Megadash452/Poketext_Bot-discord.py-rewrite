...
class Mon:
    ...
    def __init__(self, number, name, poke_specie, desc, types, abilities, clategory, stats):
        ...
        self.types = types
        self.weaknesses = self.get_weaknesses() #type_data[self.types[0]]['weaknesses'] + type_data[self.types[1]]['weaknesses']
        self.strengths = self.get_strengths() #type_data[self.types[0]]['strengths'] + type_data[self.types[1]]['strengths']
